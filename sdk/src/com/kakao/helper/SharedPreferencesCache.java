...
public class SharedPreferencesCache {
    ...
    public synchronized void reloadAll() {
        ...
        for (String key : allCachedEntries.keySet()) {
            try {
                ...
                Logger.getInstance().d("SharedPreferences.reloadAll" , "Error reading cached value for key: " + key + ", e = " + e);
            }
        }
   }
    ...
    public synchronized void save(final Bundle bundle) {
        ...
        for (String key : bundle.keySet()) {
            try {
                ...
                Logger.getInstance().d("SharedPreferences.save", "Error serializing value for key: " + key + ", e = " + e);
                return;
            }
        }
        ...
        if (!successfulCommit) {
            Logger.getInstance().d("SharedPreferences.Editor.commit() was not successful");
        } else {
            for (String key : bundle.keySet()) {
                try {
                    deserializeKey(key);
                } catch (JSONException e) {
                    Logger.getInstance().d("SharedPreferences.save", "Error deserializing value for key: " + key + ", e = " + e);
                }
            }
        }
    }
    ...
    public synchronized void clear(final List<String> keysToClear) {
        ...
        Logger.getInstance().d("Clearing keys : " + keysToClear);
    }

    public synchronized void clearAll() {
        file.edit().clear().commit();
        memory.clear();
        Logger.getInstance().d("Clearing all ");
    }
    ...
    public synchronized String getString(final String key) {
        ...
        if(value == null){
            try {
                ...
                Logger.getInstance().d("SharedPreferences.getString", "Error reading String value for key: " + key + ", e = " + e);
            }
        }
        return value;
    }
    ...
    public synchronized int getInt(final String key) {
        ...
        if(value == Integer.MIN_VALUE){
            try {
                ...
                Logger.getInstance().d("SharedPreferences.getInt", "Error reading Int value for key: " + key + ", e = " + e);
            }
        }
        return value;
    }
    ...
    public synchronized Long getLong(final String key) {
        ...
        if(value == Long.MIN_VALUE){
            try {
                ...
                Logger.getInstance().d("SharedPreferences.getLong", "Error reading Long value for key: " + key + ", e = " + e);
            }
        }
        return value;
    }
    ...
    private void deserializeKey(String key)
        ...
        if (valueType.equals(TYPE_BOOLEAN)) {
            ...
            try {
                ...
                Logger.getInstance().d("SharedPreferences.deserializeKey", "Error deserializing key '" + key + "' -- " + e);
