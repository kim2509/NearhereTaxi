...
public final class LinkObject {
    ...
    public static LinkObject newText(final String text) throws KakaoParameterException {
    ...
    public static LinkObject newImage(final String src, final int width, final int height) throws KakaoParameterException {
    ...
    public static LinkObject newButton(final String text, final Action action) throws KakaoParameterException {
        if (action == null) {
    ...
    public static LinkObject newLink(final String text, final Action action) throws KakaoParameterException {
        if (action == null) {
