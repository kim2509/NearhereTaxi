...
/**
 * Story에 로그인 되어 있는 계정을 이용하여 authorization code를 받는다.
 * @author MJ
 */
public class LoggedInStoryAuthHandler extends AuthorizationCodeHandler {

    public LoggedInStoryAuthHandler(final GetterAuthorizationCode authorizer) {
        super(authorizer);
    }

    @Override
    protected Intent getIntent(AuthorizationCodeRequest request) {
        return StoryProtocol.createLoggedInActivityIntent(authorizer.getApplicationContext(),
